...
blogs.forEach((blog) => {
    ...
    blogCard.innerHTML = `
        ...
        max-w-32 text-sm  bg-transparent items-center justify-center flex  shadow-lg  text-sky-500 duration-500 cursor-pointer active:scale-[0.98] border border-white text-white hover:bg-yellow-400 hover:text-black font-bold hover:border-none  
        ">Learn More</button>
         </div>
    `;
