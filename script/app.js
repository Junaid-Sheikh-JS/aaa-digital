...
// Sample Data Array
const slidesData = [
    { id: 1, title: "EPIXAVE", image: "assets/icons/Mark.png" },
    { id: 2, title: "Slide 2", image: "assets/icons/Fictional Company Logo.png" },
    { id: 3, title: "Slide 3", image: "assets/icons/Fictional Company Logo.png" },
    { id: 4, title: "Slide 4", image: "assets/icons/google_ico.png" },
    { id: 5, title: "Slide 5", image: "assets/icons/Fictional Company Logo.png" },
    { id: 6, title: "EPIXAVE", image: "assets/icons/Fictional Company Logo.png" },
    { id: 7, title: "Slide 2", image: "assets/icons/Fictional Company Logo.png" },
    { id: 8, title: "Slide 3", image: "assets/icons/Fictional Company Logo.png" },
    { id: 9, title: "Slide 4", image: "assets/icons/Fictional Company Logo.png"},
];
...
slidesData.forEach(slide => {
    ...
    slideElement.innerHTML = `
        <div class="slide-content w-28 h-28 flex flex-col justify-center items-center rounded-xl border-4 border-[#231e3e] p-4 transition">
            <img src="${slide.image}" alt="${slide.title}" class="w-12">
...
//                         <div class="bg-[#1C005F] rounded-xl p-3 sm:p-6 h-full sm:h-[15rem] mb-2 shadow-lg">
                            
//                             <div class="flex items-center absolute pt-">
...
//                             </div>
//                             <div class = "relative top-20 mt-5">
